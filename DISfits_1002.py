...
sp = sp3w = pyspeckit.Spectrum('UT121002_DIS.final.txt',skiplines=1,xarrkwargs={'xtype':'wavelength','unit':'angstroms'})
sp3w.specname="UT121002"
sp3w.xarr.units='angstroms'
sp3w.xarr.xtype='wavelength'
sp3w.units = 'erg s$^{-1}$ cm$^{-2}$ $\\AA^{-1}$'
sp3w.plotter(xmin=5625,xmax=6125,ymax=0.71,ymin=0.35)
...
#sp3w.specfit.parinfo.tableprint()
...
just_halpha = sp3w.copy()
just_halpha.data -= sp3w.specfit.modelcomponents[2,:]
...
oldaxis3 = sp3halpha.plotter.axis
...
sp3hbetaM = sp3hbeta * pyspeckitmodels.hydrogen.r_to_hbeta['balmera'][1]
sp3hgammaM = sp3hgamma * pyspeckitmodels.hydrogen.r_to_hbeta['balmera'][1] / pyspeckitmodels.hydrogen.r_to_hbeta['balmerg'][1]

oldaxis3.clear()
sp3halpha.plotter.axis=oldaxis3
sp3halpha.plotter(xmin=-20000,xmax=20000,ymin=-0.2,ymax=4.0)
sp3hbetaM.plotter(xmin=-20000,xmax=20000,ymin=-0.2,ymax=4.0,clear=False,axis=sp3halpha.plotter.axis,color='b')
sp3hgammaM.plotter(xmin=-20000,xmax=20000,ymin=-0.2,ymax=4.0,clear=False,axis=sp3halpha.plotter.axis,color='r')
sp3halpha.plotter.axis.legend(sp3halpha.plotter.axis.lines,
        ['H$\\alpha$','H$\\beta$','H$\\gamma$'], 
        loc='upper left')
...
sp3halpha.plotter.axis = mpl_toolkits.axes_grid.inset_locator.inset_axes(sp3halpha.plotter.axis,
        width="40%", height="40%",loc=1)
sp3halpha.plotter(xmin=-3000,xmax=3000,ymin=-0.2,ymax=4.0)
sp3halpha.plotter.axis.set_title("")
sp3hbetaM.plotter(xmin=-3000,xmax=3000,ymin=-0.2,ymax=4.0,clear=False,axis=sp3halpha.plotter.axis,color='b')
sp3hgammaM.plotter(xmin=-3000,xmax=3000,ymin=-0.2,ymax=4.0,clear=False,axis=sp3halpha.plotter.axis,color='r')
sp3halpha.plotter.axis.set_title("")

sp3halpha.plotter.savefig('SN2009ip_UT121002_Habg_compare_scaled10000K.png')
