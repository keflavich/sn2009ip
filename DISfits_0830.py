...
sp4w = pyspeckit.Spectrum('UT120830_DIS.final.txt',skiplines=1,xarrkwargs={'xtype':'wavelength','unit':'angstroms'})
...
sp4halpha.plotter(xmin=-20000,xmax=20000,ymin=-0.2,ymax=2.0)
sp4hbeta.plotter(xmin=-20000,xmax=20000,ymin=-0.2,ymax=2.0,clear=False,axis=sp4halpha.plotter.axis,color='b')
sp4hgamma.plotter(xmin=-20000,xmax=20000,ymin=-0.2,ymax=2.0,clear=False,axis=sp4halpha.plotter.axis,color='r')
...
sp4halpha.plotter(xmin=-3000,xmax=3000,ymin=-0.2,ymax=2.0)
sp4halpha.plotter.axis.set_title("")
sp4halpha.plotter.axis.set_title("")
sp4hbeta.plotter(xmin=-3000,xmax=3000,ymin=-0.2,ymax=2.0,clear=False,axis=sp4halpha.plotter.axis,color='b')
sp4hgamma.plotter(xmin=-3000,xmax=3000,ymin=-0.2,ymax=2.0,clear=False,axis=sp4halpha.plotter.axis,color='r')
